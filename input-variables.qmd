...
We base our Theme: Master Input Variables on Planning a [Minimum Viable Nothing (MVN)](https://github.com/vanHeemstraSystems/minimum-viable-nothing).

## 2. Find the **Opportunities**.

See [Learning Terraform - Input Variables](https://vanheemstrasystems.github.io/learning-terraform-input-variables/)
