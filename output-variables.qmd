...
We base our Theme: Master Output Variables on Planning a [Minimum Viable Nothing (MVN)](https://github.com/vanHeemstraSystems/minimum-viable-nothing).

## 2. Find the **Opportunities**.

See [Learning Terraform - Output Variables](https://vanheemstrasystems.github.io/learning-terraform-output-variables/)
