...
We base our Theme: Master Basic Operations on Planning a [Minimum Viable Nothing (MVN)](https://github.com/vanHeemstraSystems/minimum-viable-nothing).

## 2. Find the **Opportunities**.

See [Learning Terraform - Basic Operations](https://vanheemstrasystems.github.io/learning-terraform-basic-operations/)
